...
public class HttpInterfaceConfiguration {
    ...
    @Bean
    public CompanyServiceClient companyHttpInterface(@Qualifier("loadBalanced") RestClient.Builder restClientBuilder) {
    ...
    @Bean
    public ReviewServiceClient reviewHttpInterface(@Qualifier("loadBalanced") RestClient.Builder restClientBuilder) {
