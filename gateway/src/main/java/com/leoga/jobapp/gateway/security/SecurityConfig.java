package com.leoga.jobapp.gateway.security;
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        .pathMatchers("/actuator/**").permitAll() // For Prometheus
                        .pathMatchers("/jobs/**").hasRole("JOB")
                        .pathMatchers("/companies/**").hasRole("COMPANY")
                        .pathMatchers("/reviews/**").hasRole("REVIEW")
